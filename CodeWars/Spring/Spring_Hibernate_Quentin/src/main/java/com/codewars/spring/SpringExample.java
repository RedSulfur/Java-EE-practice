...
//        createFilm(actorService);
        participateActor(actorService,"Dylan O'Brien","Soul in shambles");
//        test4(actorService);
//        test5(actorService);
//        test6(actorService);
    }
...
//        Actor actor = new Actor("Sarah Maclachclan");
    ...
    private static void participateActor(ActorService actorService, String actorName, String filmName) {
        ...
        films_actors.setRole("Feel endless pain");
